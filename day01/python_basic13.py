...
# 知识点2：类型转换（int、str、bool、float）

# 1、int和float转换
a = 10
flt = float(a)  # 把int转换成float
print(flt)  # 10.0

it = int(10.999)  # 把10.5转换为 整数类型 并且赋值给 it
print(it)  # 10，注意：小数转整数的时候是直接舍去小数点后面的（截取整数位）

# 2、字符串和数字的转换
str1 = str(10)  # 把数字转为字符串
print(str1, type(str1))  # 10 <class 'str'>

int1 = int("10")  # 把字符串转为int类型
print(int1, type(int1))  # 10 <class 'int'>

# 布尔类型和数字之间的转换
# 1、数字类型和字符串 转为 布尔类型
boo1 = bool(10)  # 注意：数字转布尔类型 非0为True
print(boo1, type(boo1))  # True <class 'bool'>

boo2 = bool("小花")  # 注意：str转布尔类型 非空为True，非None为True
